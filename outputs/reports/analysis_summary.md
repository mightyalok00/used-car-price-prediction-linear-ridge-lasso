...
| Model             |     MAE |   MedianAE |         MSE |    RMSE |       R2 |   CV_RMSE_Mean |   CV_RMSE_Std |   Train_R2 |   Test_R2 | Best_Alpha   |   Active_Features |   Zero_Coefficients |   Fit_Seconds | CV_Fold_RMSE                                     |   Generalization_Gap_R2 | Overfit_Assessment                |
|:------------------|--------:|-----------:|------------:|--------:|---------:|---------------:|--------------:|-----------:|----------:|:-------------|------------------:|--------------------:|--------------:|:-------------------------------------------------|------------------------:|:----------------------------------|
| Linear Regression | 5898.19 |    3154.55 | 1.94394e+08 | 13942.5 | 0.732227 |        24062.5 |       8655.68 |   0.492668 |  0.732227 | N/A          |               630 |                   0 |      0.866306 | 31395.59, 15048.24, 31272.12, 28276.49, 14320.03 |               -0.239559 | test set easier or sampling shift |
| Ridge Regression  | 5903.92 |    3176.15 | 1.94383e+08 | 13942.1 | 0.732241 |        24061   |       8660.2  |   0.492695 |  0.732241 | 0.1          |               630 |                   0 |      0.458292 | 31398.06, 15034.35, 31274.66, 28277.00, 14320.79 |               -0.239546 | test set easier or sampling shift |
| Lasso Regression  | 5987.16 |    3288.91 | 1.98893e+08 | 14102.9 | 0.726029 |        24190.8 |       8625.61 |   0.485277 |  0.726029 | 0.0001       |               357 |                 273 |      0.557462 | 31527.56, 15219.12, 31329.96, 28408.97, 14468.39 |               -0.240752 | test set easier or sampling shift |

The lowest external-test RMSE belongs to **Ridge Regression**. All models train on `log1p(price)` to reduce target skew; predictions are converted back to price units before MAE, MedianAE, MSE, RMSE, and R² are calculated.
